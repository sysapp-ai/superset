 ...
 * under the License.
 */
import { SupersetPercentageCircularMeterPlugin } from '../src';
 ...
 */
describe('superset-percentage-circular-meter-plugin', () => {
  it('exists', () => {
    expect(SupersetPercentageCircularMeterPlugin).toBeDefined();
  });
});
